      ...
      <div class="bg-white rounded-xl p-6 max-w-4xl w-full modal-animation max-h-[60vh] flex flex-col">
        ...
        <div class="flex flex-1 overflow-hidden">
          ...
          <div class="w-1/3 border-r overflow-y-auto">
            ...
            <div class="update-item p-4 hover:bg-gray-50 cursor-pointer">
              <div class="font-medium">V1.1.4.beta</div>
              <div class="text-sm text-gray-500">2025-11-25</div>
            </div>
            <div class="update-item p-4 hover:bg-gray-50 cursor-pointer">
              <div class="font-medium">V1.1.3.beta</div>
              <div class="text-sm text-gray-500">2025-11-25</div>
            </div>
            <div class="update-item p-4 hover:bg-gray-50 cursor-pointer">
              <div class="font-medium">V1.1.2.beta</div>
              <div class="text-sm text-gray-500">2025-11-25</div>
            </div>
            <div class="update-item p-4 hover:bg-gray-50 cursor-pointer">
              <div class="font-medium">V1.0.1.beta</div>
          ...
          <div class="w-2/3 p-6 overflow-y-auto">
            ...
            <div class="update-content hidden">
              <h4 class="text-lg font-bold mb-3">V1.1.4.beta 更新内容（V1.3.0.HDBCNAL更新内容）</h4>
              <ul class="space-y-2">
                <li class="flex items-start">
                ...
                <li class="flex items-start">
                  <i class="fa fa-chain-broken text-red-500 mt-1 mr-2"></i>
                  <span>音乐歌单焕新！哈基米歌单下线了，听不到哈基米哦南北绿豆了QAQ</span>
                </li>
                <li class="flex items-start">
                  <i class="	fa fa-volume-up text-green-500 mt-1 mr-2"></i>
                  <span>终于轮到 东方Project 的歌单了！</span>
                </li>
                <li class="flex items-start">
            ...
            <div class="update-content hidden">
              <h4 class="text-lg font-bold mb-3">V1.1.3.beta 更新内容</h4>
              <ul class="space-y-2">
                <li class="flex items-start">
                  <i class="fa fa-plus-circle text-green-500 mt-1 mr-2"></i>
                  <span>新增哈基米音乐播放器！哈基米哦南北绿豆~阿西嘎那呀哈呀库~</span>
                </li>
              </ul>
            </div>
            <div class="update-content hidden">
              <h4 class="text-lg font-bold mb-3">V1.1.2.beta 更新内容（V1.2.0.HDBCNAL更新内容）</h4>
              <ul class="space-y-2">
                <li class="flex items-start">
                  <i class="fa fa-plus-circle text-green-500 mt-1 mr-2"></i>
            ...
            <div class="update-content hidden">
              <h4 class="text-lg font-bold mb-3">V1.0.1.beta 更新内容（V1.1.0.HDBCNAL更新内容）</h4>
              <ul class="space-y-2">
                <li class="flex items-start">
                  <i class="fa fa-plus-circle text-green-500 mt-1 mr-2"></i>
